...
return new class extends Migration
{
    ...
    {
        Schema::create('catalog_item_challenges', function (Blueprint $table) {
            $table->foreignUuid('catalog_item_id')->references('id')->on('catalog_items')->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignUuid('challenge_id'); //TODO: add constraint later when challenges are implemented
