    ...
    <div class="container flex flex-col justify-center items-center mx-auto py-8 2xl:px-48">
        ...
        <x-web.accordeon class="w-full mt-4" headline="Patch 1.2.0.5 - Dark Instinct Hotfix #5">
                    <x-web.text>
                        ...
                        Balance patch with Scavenger Bolt nerfs, and tweaks to Stalker and Burst Rifle for fairer gameplay.
                    </x-web.text>
                    <x-web.text class="font-semibold mt-4">
                        <a href="https://docs.google.com/document/d/1uquo_gSdzxeQkJSgvmBjCG7rAzBxn_DtJM1-0sxpOdg/edit?usp=sharing"
                           class="weblink" target="_blank" rel="noopener noreferrer">
                            View Full Patch Notes
                        </a>
                    </x-web.text>
        ...
        <x-web.accordeon class="w-full mt-4" headline="Patch 1.2.0.4 - Dark Instinct Hotfix #4">
            <x-web.text>
                ...
                This patch enhances Sawbones' role as a supportive team player.
            </x-web.text>
            <x-web.text class="font-semibold mt-4">
                <a href="https://docs.google.com/document/d/1UbFpH2GSRGnJVx3-oXp61NFGRgFytAFuoITrFgW30Cw/edit?usp=sharing"
                   class="weblink" target="_blank" rel="noopener noreferrer">
                    View Full Patch Notes
                </a>
            </x-web.text>
